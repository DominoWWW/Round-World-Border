...
$execute as @n[tag=rwb.move] at @s run tp @n[tag=rwb.move] ~ ~ ~ facing $(x) ~ $(z)
execute as @n[tag=rwb.move] at @s run function round_world_border:move_ray with storage round_world_border:data
